import time
import torch
from utils.utils import get_reader, train_model, create_model, save_model, parse_args, get_tagset, load_model
...
if __name__ == '__main__':
    ...
    dev_data = get_reader(file_path=sg.dev, target_vocab=get_tagset(sg.iob_tagging), encoder_model=sg.encoder_model,
                          max_instances=sg.max_instances, max_length=sg.max_length, gazetteer_path=sg.gazetteer)

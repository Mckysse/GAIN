...
def get_reader(file_path, gazetteer_path, max_instances=-1, max_length=128, target_vocab=None, encoder_model='xlm-roberta-large'):
...
def get_trainer(gpus=4, is_test=False, out_dir=None, epochs=10):
    ...
    if torch.cuda.is_available():
        trainer = pl.Trainer(logger=logger,gpus=gpus, deterministic=True, max_epochs=epochs, callbacks=[checkpoint_callback],
